...
INT_PTR CALLBACK CPLSVR1_Page4_DlgProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_TIMER:
        ZeroMemory(&dijs, sizeof(DIJOYSTATE));
        if (pdiDevice2 && SUCCEEDED(DIUtilPollJoystick(pdiDevice2, &dijs))) {
            DisplayJoystickState(hWnd, &dijs);
        }
        break;
    }
...
HRESULT DisplayAxisList(HWND hWnd, UINT uTextCtrlId, UINT uListCtrlId, LPDIRECTINPUTDEVICE2 pdiDevice2)
{
    ...
    if (poi)
    {
        ...
        if (SUCCEEDED(hRes))
        {
            ...
            OutputDebugString(TEXT("DisplayAxisList() - EnumObjects() failed!\n"));
        }
      #endif // _DEBUG
...
HRESULT DisplayButtonList(HWND hWnd, UINT uTextCtrlId, UINT uListCtrlId, LPDIRECTINPUTDEVICE2 pdiDevice2)
{
    ...
    if (poi)
    {
        ...
        if (SUCCEEDED(hRes))
        {
            ...
            OutputDebugString(TEXT("DisplayButtonList() - EnumObjects() failed!\n"));
        }
      #endif //_DEBUG
                       ...
                       LPDIRECTINPUTDEVICE2 pdiDevice2)
{
    ...
    if (poi)
    {
        ...
        if (SUCCEEDED(hRes))
        {
            ...
            OutputDebugString(TEXT("DisplayPOVList() - EnumObjects() failed!\n"));
        }
      #endif // _DEBUG
                          ...
                          LPDIRECTINPUTDEVICE2 pdiDevice2)
{
    ...
    if ( pel )
    {
        ...
        if (SUCCEEDED(hRes))
        {
            ...
            OutputDebugString(TEXT("DisplayEffectList() - EnumEffects() failed!\n"));
        }
      #endif // _DEBUG
