        ...
        case IDOK:
            {
...

                {
                    ...
                    if (sImeG.hRevKL != hKL) {
                        WORD nRevMaxKey;
                        HKEY hKeyAppUser = NULL;
                        HKEY hKeyIMEUser = NULL;
                        ...
                        if (retCode != ERROR_SUCCESS) {
                            retCode = RegCreateKey(HKEY_CURRENT_USER, REGSTR_PATH_SETUP, &hKeyCurrVersion);
                            if (retCode != ERROR_SUCCESS) {
                                return TRUE;
                            }
                        }
