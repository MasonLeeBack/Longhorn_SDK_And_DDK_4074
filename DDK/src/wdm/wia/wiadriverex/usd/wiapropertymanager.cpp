...
HRESULT CWIAPropertyManager::DeletePropertyData(PWIA_PROPERTY_INFO_DATA pInfo)
{
...
HRESULT CWIAPropertyManager::AddProperty(LONG lPropertyID, LPOLESTR szName, LONG lAccessFlags, LONG lCurrValue)
{
...
HRESULT CWIAPropertyManager::AddProperty(LONG lPropertyID, LPOLESTR szName, LONG lAccessFlags, LONG lCurrValue, LONG lValidBits)
{
...
HRESULT CWIAPropertyManager::AddProperty(LONG lPropertyID, LPOLESTR szName, LONG lAccessFlags, LONG lCurrValue,
                                         LONG lNomValue, CBasicDynamicArray<LONG> *pValueList)
{
...
HRESULT CWIAPropertyManager::AddProperty(LONG lPropertyID, LPOLESTR szName, LONG lAccessFlags, BSTR bstrCurrValue)
{
...
HRESULT CWIAPropertyManager::AddProperty(LONG lPropertyID, LPOLESTR szName, LONG lAccessFlags, GUID guidCurrValue)
{
...
HRESULT CWIAPropertyManager::AddProperty(LONG lPropertyID, LPOLESTR szName, LONG lAccessFlags, GUID guidCurrValue,
                                         GUID guidNomValue, CBasicDynamicArray<GUID> *pValueList)
{
...
HRESULT CWIAPropertyManager::SetItemProperties(BYTE *pWiasContext)
{
