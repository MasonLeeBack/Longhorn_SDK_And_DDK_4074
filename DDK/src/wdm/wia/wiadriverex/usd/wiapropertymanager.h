...
private:
    ...
    HRESULT DeletePropertyData(PWIA_PROPERTY_INFO_DATA pInfo);
...
public:
    ...
    HRESULT AddProperty(LONG lPropertyID, LPOLESTR szName, LONG lAccessFlags, LONG lCurrValue);
    HRESULT AddProperty(LONG lPropertyID, LPOLESTR szName, LONG lAccessFlags, LONG lCurrValue,
                        LONG lNomValue,
                        LONG lMinValue,
                        LONG lMaxValue,
                        LONG lInc);
    HRESULT AddProperty(LONG lPropertyID, LPOLESTR szName, LONG lAccessFlags, LONG lCurrValue,
                        LONG lNomValue, LONG *plValues, LONG lNumValues);
    HRESULT AddProperty(LONG lPropertyID, LPOLESTR szName, LONG lAccessFlags, LONG lCurrValue,
                        LONG lNomValue, CBasicDynamicArray<LONG> *pValueList);
    HRESULT AddProperty(LONG lPropertyID, LPOLESTR szName, LONG lAccessFlags, LONG lCurrValue, LONG lValidBits);

    //
    // BSTR type properties
    //

    HRESULT AddProperty(LONG lPropertyID, LPOLESTR szName, LONG lAccessFlags, BSTR bstrCurrValue);

    //
    // GUID type properties
    //

    HRESULT AddProperty(LONG lPropertyID, LPOLESTR szName, LONG lAccessFlags, GUID guidCurrValue);
    HRESULT AddProperty(LONG lPropertyID, LPOLESTR szName, LONG lAccessFlags, GUID guidCurrValue,
                        GUID guidNomValue, CBasicDynamicArray<GUID> *pValueList);


    HRESULT RemoveProperty(LONG lPropertyID);
    HRESULT SetItemProperties(BYTE *pWiasContext);
};
