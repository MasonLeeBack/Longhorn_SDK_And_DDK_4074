...
HRESULT CWIACapabilityManager::Initialize(HINSTANCE hInstance)
{
...
HRESULT CWIACapabilityManager::AllocateCapability(WIA_DEV_CAP_DRV **ppWIADeviceCapability)
{
    HRESULT hr = E_INVALIDARG;
...
void CWIACapabilityManager::FreeCapability(WIA_DEV_CAP_DRV *pWIADeviceCapability, BOOL bFreeCapabilityContentOnly)
{
    if(pWIADeviceCapability)
    {
        if(pWIADeviceCapability->guid)
