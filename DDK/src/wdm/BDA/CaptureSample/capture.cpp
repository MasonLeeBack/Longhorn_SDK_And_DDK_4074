...
#define TS_PACKETS_PER_SAMPLE 312
#define TS_SAMPLE_SIZE TS_PACKET_SIZE * TS_PACKETS_PER_SAMPLE
#define MPEG2_FRAMES_PER_SECOND 40
...

{
    ...
    if (NT_SUCCESS (Status)) {
        ...
        //
        Status = KsEdit (Pin, &Pin -> Descriptor, MS_SAMPLE_CAPTURE_POOL_TAG);
...

{
    ...
    if (!NT_SUCCESS (Status)) {
        ...
        m_TransportInfo->ulcbPhyiscalPacket = TS_PACKET_SIZE;
        m_TransportInfo->ulcbPhyiscalFrame = TS_SAMPLE_SIZE;
        m_TransportInfo->ulcbPhyiscalFrameAlignment = 1;
        m_TransportInfo->AvgTimePerFrame = NANO_SECONDS/100/MPEG2_FRAMES_PER_SECOND;
...
DECLARE_SIMPLE_FRAMING_EX (
    ...
    8,                                              //  Frames
    0,                                              //  Alignment
    TS_SAMPLE_SIZE,                                 //  MinFrameSize
    TS_SAMPLE_SIZE                                  //  MaxFrameSize
    );
