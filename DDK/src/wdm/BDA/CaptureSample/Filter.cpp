...

{
    ...
    CCaptureFilter *CapFilter = new (NonPagedPool, MS_SAMPLE_CAPTURE_POOL_TAG) CCaptureFilter (Filter);
...
#define GUID_BdaSWRcv  0xb6cf1567, 0xae45, 0x4aff, 0x90, 0x4f, 0x46, 0xcb, 0x80, 0x62, 0xf0, 0x99
