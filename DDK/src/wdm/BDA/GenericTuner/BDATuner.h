...
#if ATSC_RECEIVER
#define KSNODE_BDA_CURRENT_DEMODULATOR KSNODE_BDA_8VSB_DEMODULATOR
#endif
#if DVBT_RECEIVER
#define KSNODE_BDA_CURRENT_DEMODULATOR KSNODE_BDA_COFDM_DEMODULATOR
#endif
#if DVBS_RECEIVER
#define KSNODE_BDA_CURRENT_DEMODULATOR KSNODE_BDA_QPSK_DEMODULATOR
#endif
#if CABLE_RECEIVER
#define KSNODE_BDA_CURRENT_DEMODULATOR KSNODE_BDA_QAM_DEMODULATOR
#endif
