...
static PCPROPERTY_ITEM PropertiesDAC[] =
{
    { 
        ...
        KSPROPERTY_TYPE_SET,
        CRTMiniport::PropertyChannelConfig
    }
};
 ...
 */
NTSTATUS CRTMiniport::PropertyChannelConfig
(
...
)
{
    ...
    DOUT (DBG_PRINT, ("[CRTMiniport::PropertyChannelConfig]"));

    NTSTATUS        ntStatus = STATUS_INVALID_PARAMETER;
    // The major target is the object pointer to the wave miniport.
    CRTMiniport *that =
        (CRTMiniport *) (PRTMINIPORT)PropertyRequest->MajorTarget;
 ...
 * CreateRTMiniport
 *****************************************************************************
 * Creates a RT miniport object for the ICH adapter.
 * This uses a macro from STDUNK.H to do all the work.
 */
NTSTATUS CreateRTMiniport
(
...
)
{
    ...
    DOUT (DBG_PRINT, ("[CreateRTMiniport]"));

    STD_CREATE_BODY_WITH_TAG_(CRTMiniport,Unknown,UnknownOuter,PoolType,
                     PoolTag, PRTMINIPORT);
}


/*****************************************************************************
 * CRTMiniport::NonDelegatingQueryInterface
 *****************************************************************************
 * Obtains an interface.  This function works just like a COM QueryInterface
 * call and is used if the object is not being aggregated.
 */
STDMETHODIMP_(NTSTATUS) CRTMiniport::NonDelegatingQueryInterface
(
    IN  REFIID  Interface,
    OUT PVOID  *Object
)
{
    ...
    DOUT (DBG_PRINT, ("[CRTMiniport::NonDelegatingQueryInterface]"));

    // Is it IID_IUnknown?
    if (IsEqualGUIDAligned (Interface, IID_IUnknown))
    {
        *Object = (PVOID)(PUNKNOWN)(PRTMINIPORT)this;
    } 
    // or IID_IMiniport ...
    ...
    // or IID_IRTMiniport ...
    else if (IsEqualGUIDAligned (Interface, IID_IRTMiniport))
    {
        *Object = (PVOID)(PRTMINIPORT)this;
    } 
    // or IID_IPowerNotify ...
...
CRTMiniport::~CRTMiniport ()
{
    ...
    DOUT (DBG_PRINT, ("[CRTMiniport::~CRTMiniport]"));
 ...
 */
STDMETHODIMP_(NTSTATUS) CRTMiniport::Init
(
...
)
{
    ...
    DOUT (DBG_PRINT, ("[CRTMiniport::Init]"));
...
)
{
    ...
    DOUT (DBG_PRINT, ("[CRTMiniport::ProcessResources]"));
...
/*****************************************************************************
 * CRTMiniport::BuildDataRangeInformation
 *****************************************************************************
 ...
 */
NTSTATUS CRTMiniport::BuildDataRangeInformation (void)
{
    PAGED_CODE ();
    ...
    DOUT (DBG_PRINT, ("[CRTMiniport::BuildDataRangeInformation]"));
 ...
 */
STDMETHODIMP CRTMiniport::NewStream
(
    OUT PRTMINIPORTSTREAM       *Stream,
...
)
{
    ...
    CRTStream *pStream = NULL;
    NTSTATUS ntStatus = STATUS_SUCCESS;

    DOUT (DBG_PRINT, ("[CRTMiniport::NewStream]"));
    ...
    // Create a new stream.
    //
    ntStatus = CreateRTStream (&pStream);
    ...
    // Save the pointers.
    //
    *Stream = (PRTMINIPORTSTREAM)pStream;
...
/*****************************************************************************
 * CRTMiniport::GetDescription
 *****************************************************************************
 * Gets the topology.
 */
STDMETHODIMP_(NTSTATUS) CRTMiniport::GetDescription
(
...
)
{
    ...
    DOUT (DBG_PRINT, ("[CRTMiniport::GetDescription]"));
...
/*****************************************************************************
 * CRTMiniport::DataRangeIntersection
 *****************************************************************************
 ...
 */
STDMETHODIMP_(NTSTATUS) CRTMiniport::DataRangeIntersection
(
    IN      ULONG           PinId,
...
)
{
    ...
    DOUT (DBG_PRINT, ("[CRTMiniport::DataRangeIntersection]"));
 ...
 * specification.
 */
NTSTATUS CRTMiniport::TestDataFormat
(
...
)
{
    ...
    DOUT (DBG_PRINT, ("[CRTMiniport::TestDataFormat]"));
 ...
 */
STDMETHODIMP_(void) CRTMiniport::PowerChangeNotify
(
...
) 
{
    ...
    DOUT (DBG_PRINT, ("[CRTMiniport::PowerChangeNotify]"));
...
)
{
    ...
    //
    // Get our context which is a pointer to class CRTMiniport.
    //
    CRTMiniport *that = (CRTMiniport *)DynamicContext;
