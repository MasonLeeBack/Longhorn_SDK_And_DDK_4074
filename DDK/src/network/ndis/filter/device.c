    ...
    )
{
    ...
    PFILTER_DEVICE_EXTENSION        FilterDriverExtension;
    ...
    DeviceAttribute.ExtensionSize = sizeof(FilterDriverExtension);
    ...
    {
        FilterDriverExtension = NdisGetDeviceReservedExtension(NdisFilterDeviceHandle);
   
        FilterDriverExtension->Signature = 'FTDR';
        FilterDriverExtension->Handle = FilterDriverHandle;
    ...
    )
{
    ...
    FilterDeviceExtension = (PFILTER_DEVICE_EXTENSION)NdisGetDeviceReservedExtension(NdisFilterDeviceHandle);
