...
Language=English
%1!-20s! Find devices that match the specific hardware or%n                     instance ID.
.
...
Language=English
%1!-20s! Enable devices that match the specific hardware or%n                     instance ID.
.
...
Language=English
%1!-20s! Disable devices that match the specific hardware or%n                     instance ID.
.
...
Language=English
%1!-20s! Restart devices that match the specific hardware or%n                     instance ID.
.
...
Language=English
%1!-20s! Remove devices that match the specific hardware or%n                     instance ID.
.
...
;// POLICY
;//
MessageId=61700 SymbolicName=MSG_POLICY_LONG
Language=English
%1 policy [-m:\\<machine>] <subcmd> <policytype> [<subcommandvalue> ...] <id>
Examples of <id> are:
*                  - All devices
ISAPNP\PNP0501     - Hardware ID
*PNP*              - Hardware ID with wildcards (* matches anything)
...
If IRQPriority is chosen:
Set - Subcommandvalue includes a single integer between 1 and 3 - 
      see DDK for details.

If IRQAffinity is chosen:
Set - Subcommandvalue includes an integer between 0 and 5 - see DDK for 
      details - and an an interrupt affinity.

Examples:

%1 policy get IRQPriority *PNP* - will get IRQPriority 
    policy for a device matching *PNP*
    
%1 policy set IRQAffinity 2 ISAPNP\PNP0501 - sets PNP0501 
    to "One Close Processor"
    
%1 policy set IRQAffinity 4 3 ISAPNP\PNP0501 - sets PNP0501 
    to the processors 0 and 1 (bit 0 and bit 1 taken together 
    make "3")
.
MessageId=61701 SymbolicName=MSG_POLICY_SHORT
Language=English
%1!-20s! Manipulates policy associated with a device.
.
MessageId=61702 SymbolicName=MSG_DUMP_POLICY
Language=English
Device is currently using the following policy:
.
MessageId=61703 SymbolicName=MSG_POLICY_SET
Language=English
%1!u! device(s) policy set.
.
MessageId=61704 SymbolicName=MSG_POLICY_RESTART
Language=English
Restart the device to make the change effective.
.
