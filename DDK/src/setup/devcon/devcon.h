...
typedef CONFIGRET (WINAPI *GetLinkNodeIDProto)(IN DEVINST dnDevInst,
                                               OUT LPCTSTR Buffer,
                                               IN ULONG BufferSize,
                                               IN ULONG ulFlags,
...
#ifdef _UNICODE
#define CMGETLINKNODEID "CM_Get_Link_Node_ID_ExW"
#else
#define CMGETLINKNODEID "CM_Get_Link_Node_ID_ExA"
#endif

typedef CONFIGRET (WINAPI *DeviceAffinityPolicyProto)(IN DEVINST  dnDevInst,
...
#define DEVICEAFFINITYPOLICY "CM_Device_Affinity_Policy_Ex"
