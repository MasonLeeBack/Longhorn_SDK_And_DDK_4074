...
Serenum_IoSyncIoctlEx(ULONG Ioctl, BOOLEAN Internal, PDEVICE_OBJECT PDevObj,
		      PKEVENT PEvent,
		      __in_bcount(InBufferLen) __opt PVOID PInBuffer,
		      __in ULONG InBufferLen,
		      __out_bcount(OutBufferLen) __opt PVOID POutBuffer,
...
Serenum_GetRegistryKeyValue (
    ...
    __out __opt PULONG ActualLength);
...
SerenumCheckForLegacyDevice(IN PFDO_DEVICE_DATA PFdoData,
			    __in_bcount(BufferLen) PCHAR PReadBuf,
