...
//
#define PKID_IS_KEY_PRESSURE_UPDATE(pkid) (((pkid)->PressureExtended & PRESSURE_UPDATE_FLAG) ? TRUE : FALSE)
#define PKID_GET_KEY_PRESSURE_DATA(pkid) ((pkid)->PressureData)
#define PKID_SET_KEY_PRESSURE_DATA(pkid, val) ((pkid)->PressureData = (val))
