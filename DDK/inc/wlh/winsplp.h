...
typedef struct _PRINTPROVIDOR {
   ...
   BOOL (*fpDeletePrinterConnection2)(LPCWSTR   pName,
                                      DWORD     dwFlags);
   ...
   BOOL (*fpEnumFormsEx)(HANDLE  hPrinter,
                       DWORD   Level,
                       LPBYTE  pForm,
                       DWORD   cbBuf,
                       LPDWORD pcbNeeded,
   ...
   HRESULT (*fpAddJobEx)(HANDLE                         hPrinter,
                         PrintPropertiesCollection*     propertiesCollection,
                         PrintPropertiesCollection**    ppJobDataOutCollection);

   
   HRESULT (*fpGetJobEx)(HANDLE                         hPrinter,
                         ULONG                          jobIdentifier,
                         PrintPropertiesCollection**    propertiesCollection);
...
PartialReplyPrinterChangeNotification(
    IN      HANDLE                      hNotify,
    IN      PPRINTER_NOTIFY_INFO_DATA   pInfoDataSrc
    );
...
SpoolerFindNextPrinterChangeNotification(
    ...
    IN      PVOID                   pvReserved0,
        OUT PVOID                   ppPrinterNotifyInfo
    );
...
SpoolerRefreshPrinterChangeNotification(
    ...
    IN      PPRINTER_NOTIFY_OPTIONS pOptions,
        OUT PPRINTER_NOTIFY_INFO    *ppInfo
    );
