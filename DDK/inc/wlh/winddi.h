...
#define INDEX_DrvReserved12                     93L
#define INDEX_DrvReserved13                     94L
#define INDEX_DrvReserved14                     95L
#define INDEX_DrvReserved15                     96L
#define INDEX_DrvReserved16                     97L
#define INDEX_DrvReserved17                     98L
#define INDEX_DrvReserved18                     99L
#define INDEX_DrvReserved19                     100L
#define INDEX_DrvReserved20                     101L
#define INDEX_DrvReserved21                     102L
#define INDEX_DrvReserved22                     103L
#define INDEX_DrvReserved23                     104L
#define INDEX_DrvReserved24                     105L
#define INDEX_DrvReserved25                     106L
#define INDEX_DrvReserved26                     107L
#define INDEX_DrvReserved27                     108L
#define INDEX_DrvRenderHint                     109L
/* The total number of dispatched functions */
#define INDEX_LAST                              110L
...
VOID APIENTRY DrvRenderHint(DHPDEV dhpdev, HANDLE h, PRECTL prcl);
...
#define WO_RGN_WINDOW_ALL       0x0200
...
ULONG APIENTRY WNDOBJ_cEnumStartEx(
    WNDOBJ  *pwo,
    ULONG    iType,
    ULONG    iDirection,
    ULONG    cLimit,
...
VOID APIENTRY EngRenderHint(DHPDEV dhpdev, HANDLE h, PRECTL prcl);
...
HANDLE APIENTRY EngGetCurrentThreadId(VOID);

/*
 * Engine callback - return current process id
 */

HANDLE APIENTRY EngGetCurrentProcessId(VOID);
...
VOID APIENTRY EngMultiByteToUnicodeN(
    __out_bcount(MaxBytesInUnicodeString) LPWSTR UnicodeString,
    __in ULONG MaxBytesInUnicodeString,
    __out __opt PULONG BytesInUnicodeString,
...
VOID APIENTRY EngUnicodeToMultiByteN(
    __out_bcount(MaxBytesInMultiByteString) PCHAR MultiByteString,
    __in ULONG MaxBytesInMultiByteString,
    __out __opt PULONG BytesInMultiByteString,
...
INT APIENTRY EngMultiByteToWideChar(
    UINT CodePage,
    __out_bcount(BytesInWideCharString) LPWSTR WideCharString,
    __in INT BytesInWideCharString,
    __in_bcount(BytesInMultiByteString) LPSTR MultiByteString,
    __in INT BytesInMultiByteString
    );

INT APIENTRY EngWideCharToMultiByte(
    UINT CodePage,
    __in_bcount(BytesInWideCharString) LPWSTR WideCharString,
    __in INT BytesInWideCharString,
    __out_bcount(BytesInMultiByteString) LPSTR MultiByteString,
    __in INT BytesInMultiByteString
    );
...
typedef VOID   (APIENTRY *PFN_DrvRenderHint)(DHPDEV, HANDLE, PRECTL);
...
typedef PVOID (APIENTRY *PFN_BRUSHOBJ_pvAllocRbrush)(
    BRUSHOBJ *pbo,
    ULONG     cj
    );

typedef PVOID (APIENTRY *PFN_BRUSHOBJ_pvGetRbrush)(
    BRUSHOBJ *pbo
    );

typedef ULONG (APIENTRY *PFN_BRUSHOBJ_ulGetBrushColor)(
    BRUSHOBJ *pbo
    );

typedef HANDLE (APIENTRY *PFN_BRUSHOBJ_hGetColorTransform)(
    BRUSHOBJ *pbo
    );

typedef ULONG (APIENTRY *PFN_CLIPOBJ_cEnumStart)(
    CLIPOBJ *pco,
    BOOL     bAll,
    ULONG    iType,
    ULONG    iDirection,
...
typedef BOOL (APIENTRY *PFN_CLIPOBJ_bEnum)(
    CLIPOBJ *pco,
    ULONG    cj,
    ULONG   *pul
    );

typedef PATHOBJ* (APIENTRY *PFN_CLIPOBJ_ppoGetPath)(
    CLIPOBJ* pco
    );

typedef ULONG (APIENTRY *PFN_FONTOBJ_cGetAllGlyphHandles)(
    FONTOBJ *pfo,
    HGLYPH  *phg
    );

typedef VOID (APIENTRY *PFN_FONTOBJ_vGetInfo)(
    FONTOBJ  *pfo,
    ULONG     cjSize,
    FONTINFO *pfi
    );

typedef ULONG (APIENTRY *PFN_FONTOBJ_cGetGlyphs)(
    FONTOBJ *pfo,
    ULONG    iMode,
    ULONG    cGlyph,
    HGLYPH  *phg,
...
typedef GAMMA_TABLES* (APIENTRY *PFN_FONTOBJ_pGetGammaTables)(
    FONTOBJ *pfo
    );

typedef XFORMOBJ * (APIENTRY *PFN_FONTOBJ_pxoGetXform)(
    FONTOBJ *pfo
    );

typedef IFIMETRICS * (APIENTRY *PFN_FONTOBJ_pifi)(
    FONTOBJ *pfo
    );

typedef FD_GLYPHSET * (APIENTRY *PFN_FONTOBJ_pfdg)(
    FONTOBJ *pfo
    );

typedef PVOID (APIENTRY *PFN_FONTOBJ_pvTrueTypeFontFile)(
    FONTOBJ *pfo,
    ULONG   *pcjFile
    );

typedef PBYTE (APIENTRY *PFN_FONTOBJ_pjOpenTypeTablePointer )(
    FONTOBJ *pfo,
    ULONG    ulTag,
    ULONG   *pcjTable
    );

typedef LPWSTR (APIENTRY *PFN_FONTOBJ_pwszFontFilePaths )(
    FONTOBJ *pfo,
    ULONG   *pcwc
    );

typedef PFD_GLYPHATTR (APIENTRY *PFN_FONTOBJ_pQueryGlyphAttrs)(
    FONTOBJ       *pfo,
    ULONG          iMode
    );

typedef ULONG (APIENTRY *PFN_PALOBJ_cGetColors)(
    PALOBJ *ppalo,
    ULONG   iStart,
    ULONG   cColors,
    ULONG  *pulColors
...
typedef VOID (APIENTRY *PFN_PATHOBJ_vEnumStart)(
    PATHOBJ *ppo
    );

typedef BOOL (APIENTRY *PFN_PATHOBJ_bEnum)(
    PATHOBJ  *ppo,
    PATHDATA *ppd
    );

typedef VOID (APIENTRY *PFN_PATHOBJ_vEnumStartClipLines)(
    PATHOBJ   *ppo,
    CLIPOBJ   *pco,
    SURFOBJ   *pso,
    LINEATTRS *pla
...
typedef BOOL (APIENTRY *PFN_PATHOBJ_bEnumClipLines)(
    PATHOBJ  *ppo,
    ULONG     cb,
    CLIPLINE *pcl
    );

typedef BOOL (APIENTRY *PFN_PATHOBJ_bMoveTo)(
    PATHOBJ    *ppo,
    POINTFIX    ptfx
    );

typedef BOOL (APIENTRY *PFN_PATHOBJ_bPolyLineTo)(
    PATHOBJ   *ppo,
    POINTFIX  *pptfx,
    ULONG      cptfx
    );

typedef BOOL (APIENTRY *PFN_PATHOBJ_bPolyBezierTo)(
    PATHOBJ   *ppo,
    POINTFIX  *pptfx,
    ULONG      cptfx
    );

typedef BOOL (APIENTRY *PFN_PATHOBJ_bCloseFigure)(
    PATHOBJ *ppo
    );

typedef VOID (APIENTRY *PFN_PATHOBJ_vGetBounds)(
    PATHOBJ *ppo,
    PRECTFX prectfx
    );

typedef VOID (APIENTRY *PFN_STROBJ_vEnumStart)(
    STROBJ *pstro
    );

typedef BOOL (APIENTRY *PFN_STROBJ_bEnum)(
    STROBJ    *pstro,
    ULONG     *pc,
    PGLYPHPOS *ppgpos
    );

typedef BOOL (APIENTRY *PFN_STROBJ_bEnumPositionsOnly)(
    STROBJ    *pstro,
    ULONG     *pc,
    PGLYPHPOS *ppgpos
    );

typedef DWORD (APIENTRY *PFN_STROBJ_dwGetCodePage)(
    STROBJ  *pstro
    );

typedef FIX (APIENTRY *PFN_STROBJ_fxCharacterExtra)(
    STROBJ  *pstro
    );

typedef FIX (APIENTRY *PFN_STROBJ_fxBreakExtra)(
    STROBJ  *pstro
    );

typedef BOOL (APIENTRY *PFN_STROBJ_bGetAdvanceWidths)(
    STROBJ   *pso,
    ULONG     iFirst,
    ULONG     c,
    POINTQF  *pptqD
...
typedef VOID (APIENTRY *PFN_VidMemFree)(
    IN PVOID  pvmh,
    IN FLATPTR  ptr
    );

typedef ULONG (APIENTRY *PFN_XFORMOBJ_iGetXform)(
    XFORMOBJ *pxo,
    XFORML   *pxform
    );

typedef BOOL (APIENTRY *PFN_XFORMOBJ_bApplyXform)(
    XFORMOBJ *pxo,
    ULONG     iMode,
    ULONG     cPoints,
    PVOID     pvIn,
...
typedef ULONG (APIENTRY *PFN_XLATEOBJ_iXlate)(
    XLATEOBJ *pxlo,
    ULONG iColor
    );

typedef ULONG * (APIENTRY *PFN_XLATEOBJ_piVector)(
    XLATEOBJ *pxlo
    );

typedef ULONG (APIENTRY *PFN_XLATEOBJ_cGetPalette)(
    XLATEOBJ *pxlo,
    ULONG     iPal,
    ULONG     cPal,
    ULONG    *pPal
...
typedef HANDLE (APIENTRY *PFN_XLATEOBJ_hGetColorTransform)(
    XLATEOBJ *pxlo
    );

typedef VOID (APIENTRY *PFN_EngSetLastError)(ULONG);

typedef ULONG (APIENTRY *PFN_EngGetLastError)();

typedef HBITMAP (APIENTRY *PFN_EngCreateBitmap)(
    SIZEL sizl,
    LONG  lWidth,
    ULONG iFormat,
    FLONG fl,
...
typedef HSURF (APIENTRY *PFN_EngCreateDeviceSurface)(
    DHSURF dhsurf,
    SIZEL sizl,
    ULONG iFormatCompat
    );

typedef HBITMAP (APIENTRY *PFN_EngCreateDeviceBitmap)(
    DHSURF dhsurf,
    SIZEL sizl,
    ULONG iFormatCompat
    );

typedef BOOL (APIENTRY *PFN_EngDeleteSurface)(
    HSURF hsurf
    );

typedef SURFOBJ * (APIENTRY *PFN_EngLockSurface)(
    HSURF hsurf
    );

typedef VOID (APIENTRY *PFN_EngUnlockSurface)(
    SURFOBJ *pso
    );

typedef BOOL (APIENTRY *PFN_EngEraseSurface)(
    SURFOBJ *pso,
    RECTL   *prcl,
    ULONG    iColor
    );

typedef BOOL (APIENTRY *PFN_EngAssociateSurface)(
    HSURF hsurf,
    HDEV  hdev,
    FLONG flHooks
    );

typedef BOOL (APIENTRY *PFN_EngModifySurface)(
    HSURF   hsurf,
    HDEV    hdev,
    FLONG   flHooks,
    FLONG   flSurface,
...
typedef BOOL (APIENTRY *PFN_EngMarkBandingSurface)(
    HSURF hsurf
    );

typedef BOOL (APIENTRY *PFN_EngCheckAbort)(
    SURFOBJ *pso
    );

typedef PATHOBJ * (APIENTRY *PFN_EngCreatePath)();

typedef VOID (APIENTRY *PFN_EngDeletePath)(
    PATHOBJ *ppo
    );

typedef HPALETTE (APIENTRY *PFN_EngCreatePalette)(
    ULONG  iMode,
    ULONG  cColors,
    ULONG *pulColors,
    FLONG  flRed,
...
typedef ULONG (APIENTRY *PFN_EngQueryPalette)(
    HPALETTE    hpal,
    ULONG      *piMode,
    ULONG       cColors,
    ULONG      *pulColors);

typedef BOOL (APIENTRY *PFN_EngDeletePalette)(
    HPALETTE hpal
    );

typedef CLIPOBJ * (APIENTRY *PFN_EngCreateClip)();

typedef VOID (APIENTRY *PFN_EngDeleteClip)(
    CLIPOBJ *pco
    );

typedef WNDOBJ * (APIENTRY *PFN_EngCreateWnd)(
    SURFOBJ         *pso,
    HWND             hwnd,
    WNDOBJCHANGEPROC pfn,
    FLONG            fl,
...
typedef VOID (APIENTRY *PFN_EngDeleteWnd)(
    WNDOBJ  *pwo
    );

typedef ULONG (APIENTRY *PFN_WNDOBJ_cEnumStart)(
    WNDOBJ  *pwo,
    ULONG    iType,
    ULONG    iDirection,
    ULONG    cLimit
...
typedef BOOL (APIENTRY *PFN_WNDOBJ_bEnum)(
    WNDOBJ  *pwo,
    ULONG    cj,
    ULONG   *pul
    );

typedef VOID (APIENTRY *PFN_WNDOBJ_vSetConsumer)(
    WNDOBJ  *pwo,
    PVOID    pvConsumer
    );
...
typedef ULONG (APIENTRY *PFN_EngHangNotification)(
    HDEV hdev,
    PVOID Reserved
    );

typedef HDRVOBJ (APIENTRY *PFN_EngCreateDriverObj)(
    PVOID pvObj,
    FREEOBJPROC pFreeObjProc,
    HDEV hdev
    );

typedef BOOL (APIENTRY *PFN_EngDeleteDriverObj)(
    HDRVOBJ hdo,
    BOOL bCallBack,
    BOOL bLocked
    );

typedef DRIVEROBJ* (APIENTRY *PFN_EngLockDriverObj)(
    HDRVOBJ hdo
    );

typedef BOOL (APIENTRY *PFN_EngUnlockDriverObj)(
    HDRVOBJ hdo
    );

typedef HANDLE (APIENTRY *PFN_EngGetProcessHandle)();

typedef HANDLE (APIENTRY *PFN_EngGetCurrentThreadId)();

typedef HANDLE (APIENTRY *PFN_EngGetCurrentProcessId)();

typedef BOOL (APIENTRY *PFN_EngBitBlt)(
    SURFOBJ  *psoTrg,
    SURFOBJ  *psoSrc,
    SURFOBJ  *psoMask,
    CLIPOBJ  *pco,
...
typedef BOOL (APIENTRY *PFN_EngLineTo)(
    SURFOBJ   *pso,
    CLIPOBJ   *pco,
    BRUSHOBJ  *pbo,
    LONG       x1,
...
typedef BOOL (APIENTRY *PFN_EngStretchBlt)(
    SURFOBJ         *psoDest,
    SURFOBJ         *psoSrc,
    SURFOBJ         *psoMask,
    CLIPOBJ         *pco,
...
typedef BOOL (APIENTRY *PFN_EngStretchBltROP)(
    SURFOBJ         *psoDest,
    SURFOBJ         *psoSrc,
    SURFOBJ         *psoMask,
    CLIPOBJ         *pco,
...
typedef BOOL (APIENTRY *PFN_EngAlphaBlend)(
    SURFOBJ       *psoDest,
    SURFOBJ       *psoSrc,
    CLIPOBJ       *pco,
    XLATEOBJ      *pxlo,
...
typedef BOOL (APIENTRY *PFN_EngGradientFill)(
    SURFOBJ         *psoDest,
    CLIPOBJ         *pco,
    XLATEOBJ        *pxlo,
    TRIVERTEX       *pVertex,
...
typedef BOOL (APIENTRY *PFN_EngTransparentBlt)(
    SURFOBJ    *psoDst,
    SURFOBJ    *psoSrc,
    CLIPOBJ    *pco,
    XLATEOBJ   *pxlo,
...
typedef BOOL (APIENTRY *PFN_EngTextOut)(
    SURFOBJ  *pso,
    STROBJ   *pstro,
    FONTOBJ  *pfo,
    CLIPOBJ  *pco,
...
typedef BOOL (APIENTRY *PFN_EngStrokePath)(
    SURFOBJ   *pso,
    PATHOBJ   *ppo,
    CLIPOBJ   *pco,
    XFORMOBJ  *pxo,
...
typedef BOOL (APIENTRY *PFN_EngFillPath)(
    SURFOBJ  *pso,
    PATHOBJ  *ppo,
    CLIPOBJ  *pco,
    BRUSHOBJ *pbo,
...
typedef BOOL (APIENTRY *PFN_EngStrokeAndFillPath)(
    SURFOBJ   *pso,
    PATHOBJ   *ppo,
    CLIPOBJ   *pco,
    XFORMOBJ  *pxo,
...
typedef BOOL (APIENTRY *PFN_EngPaint)(
    SURFOBJ  *pso,
    CLIPOBJ  *pco,
    BRUSHOBJ *pbo,
    POINTL   *pptlBrushOrg,
...
typedef BOOL (APIENTRY *PFN_EngCopyBits)(
    SURFOBJ  *psoDest,
    SURFOBJ  *psoSrc,
    CLIPOBJ  *pco,
    XLATEOBJ *pxlo,
...
typedef ULONG (APIENTRY *PFN_EngSetPointerShape)(
    SURFOBJ  *pso,
    SURFOBJ  *psoMask,
    SURFOBJ  *psoColor,
    XLATEOBJ *pxlo,
...
typedef VOID (APIENTRY *PFN_EngMovePointer)(
    SURFOBJ  *pso,
    LONG      x,
    LONG      y,
    RECTL    *prcl
...
typedef BOOL (APIENTRY *PFN_EngPlgBlt)(
    SURFOBJ         *psoTrg,
    SURFOBJ         *psoSrc,
    SURFOBJ         *psoMsk,
    CLIPOBJ         *pco,
...
typedef ULONG (APIENTRY *PFN_EngDitherColor)(
    HDEV   hdev,
    ULONG  iMode,
    ULONG  rgb,
    ULONG *pul
...
typedef BOOL (APIENTRY *PFN_EngControlSprites)(
    WNDOBJ  *pwo,
    FLONG    fl
    );

typedef LONG (APIENTRY *PFN_HT_ComputeRGBGammaTable)(
    USHORT  GammaTableEntries,
    USHORT  GammaTableType,
    USHORT  RedGamma,
    USHORT  GreenGamma,
...
typedef LONG (APIENTRY *PFN_HT_Get8BPPFormatPalette)(
    LPPALETTEENTRY  pPaletteEntry,
    USHORT          RedGamma,
    USHORT          GreenGamma,
    USHORT          BlueGamma
...
typedef LONG (APIENTRY *PFN_HT_Get8BPPMaskPalette)(
    LPPALETTEENTRY  pPaletteEntry,
    BOOL            Use8BPPMaskPal,
    BYTE            CMYMask,
    USHORT          RedGamma,
...
typedef FLATPTR (APIENTRY *PFN_HeapVidMemAllocAligned)(
    PVOID VidMem,
    DWORD dwWidth,
    DWORD dwHeight,
    PVOID lpAlignment,
...
typedef LONG (APIENTRY  *PFN_HTUI_DeviceColorAdjustment)(
    LPSTR           pDeviceName,
    PDEVHTADJDATA   pDevHTAdjData
    );

typedef VOID (APIENTRY *PFN_EngDebugBreak)(
    VOID
    );

typedef VOID (APIENTRY *PFN_EngDebugPrint)(
    PCHAR StandardPrefix,
    PCHAR DebugMessage,
    va_list ap
    );

typedef HRESULT (APIENTRY *PFN_EngDxIoctl)(
    ULONG ulIoctl,
    PVOID pBuffer,
    ULONG ulBufferSize
    );

typedef VOID (APIENTRY *PFN_EngQueryPerformanceCounter)(
    LONGLONG  *pPerformanceCount
    );

typedef VOID (APIENTRY *PFN_EngQueryPerformanceFrequency)(
    LONGLONG  *pFrequency
    );

typedef BOOL (APIENTRY *PFN_EngSetPointerTag)(
    HDEV       hdev,
    SURFOBJ   *psoMask,
    SURFOBJ   *psoColor,
    XLATEOBJ  *pxlo,
...
typedef PVOID (APIENTRY *PFN_EngAllocMem)(
    ULONG Flags,
    ULONG MemSize,
    ULONG Tag
    );

typedef VOID (APIENTRY *PFN_EngFreeMem)(
    PVOID Mem
    );

typedef PVOID (APIENTRY *PFN_EngAllocUserMem)(
    SIZE_T cj,
    ULONG tag
    );

typedef VOID (APIENTRY *PFN_EngFreeUserMem)(
    PVOID pv
    );

typedef PVOID (APIENTRY *PFN_EngAllocPrivateUserMem)(
    PDD_SURFACE_LOCAL psl,
    SIZE_T cj,
    ULONG tag
    );

typedef int (APIENTRY *PFN_EngMulDiv)(
    int a,
    int b,
    int c
    );

typedef VOID (APIENTRY *PFN_EngProbeForRead)(
    PVOID Address,
    ULONG Length,
    ULONG Alignment
    );

typedef VOID (APIENTRY *PFN_EngProbeForReadAndWrite)(
    PVOID Address,
    ULONG Length,
    ULONG Alignment
    );

typedef HANDLE (APIENTRY *PFN_EngSecureMem)(
    PVOID Address,
    ULONG Length
    );

typedef VOID (APIENTRY *PFN_EngUnsecureMem)(
    HANDLE hSecure
    );

typedef DWORD (APIENTRY *PFN_EngDeviceIoControl)(
    HANDLE hDevice,
    DWORD dwIoControlCode,
    LPVOID lpInBuffer,
    DWORD nInBufferSize,
...
typedef HANDLE (APIENTRY *PFN_EngLoadImage)(
    LPWSTR pwszDriver
    );

typedef PVOID (APIENTRY *PFN_EngFindImageProcAddress)(
    HANDLE hModule,
    LPSTR lpProcName
    );

typedef VOID (APIENTRY *PFN_EngUnloadImage)(
    HANDLE hModule
    );

typedef PVOID (APIENTRY *PFN_EngMapModule)(
    HANDLE h,
    PULONG pSize
    );

typedef LPWSTR (APIENTRY *PFN_EngGetPrinterDataFileName)(
    HDEV hdev
    );

typedef LPWSTR (APIENTRY *PFN_EngGetDriverName)(
    HDEV hdev
    );

typedef BOOL (APIENTRY *PFN_EngGetType1FontList)(
    HDEV            hdev,
    TYPE1_FONT      *pType1Buffer,
    ULONG           cjType1Buffer,
    PULONG          pulLocalFonts,
...
typedef HANDLE (APIENTRY *PFN_EngLoadModule)(
    LPWSTR pwsz
    );

typedef PVOID (APIENTRY *PFN_EngFindResource)(
    HANDLE h,
    int    iName,
    int    iType,
    PULONG pulSize
...
typedef VOID (APIENTRY *PFN_EngFreeModule)(
    HANDLE h
    );

typedef VOID (APIENTRY *PFN_EngFreePrivateUserMem)(
    PDD_SURFACE_LOCAL psl,
    PVOID pv
    );

typedef BOOL (APIENTRY *PFN_EngDeleteFile)(
    LPWSTR  pwszFileName
    );

typedef PVOID (APIENTRY *PFN_EngMapFile)(
    LPWSTR      pwsz,
    ULONG       cjSize,
    ULONG_PTR  *piFile
    );

typedef BOOL (APIENTRY *PFN_EngUnmapFile)(
     ULONG_PTR iFile
     );

typedef VOID (APIENTRY *PFN_EngUnmapFontFile)(
    ULONG_PTR iFile
    );

typedef BOOL (APIENTRY *PFN_EngMapFontFile)(
    ULONG_PTR  iFile,
    PULONG *ppjBuf,
    ULONG  *pcjBuf
    );

typedef VOID (APIENTRY *PFN_EngUnmapFontFileFD)(
    ULONG_PTR iFile
    );

typedef BOOL (APIENTRY *PFN_EngMapFontFileFD)(
    ULONG_PTR  iFile,
    PULONG *ppjBuf,
    ULONG  *pcjBuf
    );

typedef BOOL (APIENTRY *PFN_EngLpkInstalled)();

typedef HSEMAPHORE (APIENTRY *PFN_EngCreateSemaphore)(
    VOID
    );

typedef VOID (APIENTRY *PFN_EngAcquireSemaphore)(
    HSEMAPHORE hsem
    );

typedef VOID (APIENTRY *PFN_EngReleaseSemaphore)(
    HSEMAPHORE hsem
    );

typedef VOID (APIENTRY *PFN_EngDeleteSemaphore)(
    HSEMAPHORE hsem
    );

typedef BOOL (APIENTRY *PFN_EngIsSemaphoreOwned)(
    HSEMAPHORE hsem
    );

typedef BOOL (APIENTRY *PFN_EngIsSemaphoreOwnedByCurrentThread)(
    HSEMAPHORE hsem
    );

typedef BOOL (APIENTRY *PFN_EngInitializeSafeSemaphore)(
    ENGSAFESEMAPHORE *pssem
    );

typedef VOID (APIENTRY *PFN_EngDeleteSafeSemaphore)(
    ENGSAFESEMAPHORE *pssem
    );

typedef VOID (APIENTRY *PFN_EngMultiByteToUnicodeN)(
...
typedef VOID (APIENTRY *PFN_EngUnicodeToMultiByteN)(
    PCHAR MultiByteString,
...
typedef BOOL (APIENTRY *PFN_EngGetPrinterDriver)(
    HANDLE  hPrinter,
    LPWSTR  pEnvironment,
    DWORD   dwLevel,
    BYTE   *lpbDrvInfo,
...
typedef DWORD (APIENTRY *PFN_EngGetPrinterData)(
    HANDLE   hPrinter,
    LPWSTR    pValueName,
    LPDWORD  pType,
    LPBYTE   pData,
...
typedef DWORD (APIENTRY *PFN_EngSetPrinterData)(
    HANDLE   hPrinter,
    LPWSTR   pType,
    DWORD    dwType,
    LPBYTE   lpbPrinterData,
...
typedef BOOL (APIENTRY *PFN_EngGetForm)(
    HANDLE  hPrinter,
    LPWSTR   pFormName,
    DWORD   Level,
    LPBYTE  pForm,
...
typedef BOOL (APIENTRY *PFN_EngWritePrinter)(
    HANDLE  hPrinter,
    LPVOID  pBuf,
    DWORD   cbBuf,
    LPDWORD pcWritten
...
typedef BOOL (APIENTRY *PFN_EngGetPrinter)(
    HANDLE  hPrinter,
    DWORD   dwLevel,
    LPBYTE  pPrinter,
    DWORD   cbBuf,
...
typedef BOOL (APIENTRY *PFN_EngEnumForms)(
    HANDLE  hPrinter,
    DWORD   Level,
    LPBYTE  pForm,
    DWORD   cbBuf,
...
#if defined(_X86_)
typedef     VOID (APIENTRY *PFN_FLOATOBJ_SetFloat)(PFLOATOBJ,FLOATL);
typedef     VOID (APIENTRY *PFN_FLOATOBJ_SetLong)(PFLOATOBJ,LONG);
typedef     LONG (APIENTRY *PFN_FLOATOBJ_GetFloat)(PFLOATOBJ);
typedef     LONG (APIENTRY *PFN_FLOATOBJ_GetLong)(PFLOATOBJ);
typedef     VOID (APIENTRY *PFN_FLOATOBJ_AddFloat)(PFLOATOBJ,FLOATL);
typedef     VOID (APIENTRY *PFN_FLOATOBJ_AddLong)(PFLOATOBJ,LONG);
typedef     VOID (APIENTRY *PFN_FLOATOBJ_Add)(PFLOATOBJ,PFLOATOBJ);
typedef     VOID (APIENTRY *PFN_FLOATOBJ_SubFloat)(PFLOATOBJ,FLOATL);
typedef     VOID (APIENTRY *PFN_FLOATOBJ_SubLong)(PFLOATOBJ,LONG);
typedef     VOID (APIENTRY *PFN_FLOATOBJ_Sub)(PFLOATOBJ,PFLOATOBJ);
typedef     VOID (APIENTRY *PFN_FLOATOBJ_MulFloat)(PFLOATOBJ,FLOATL);
typedef     VOID (APIENTRY *PFN_FLOATOBJ_MulLong)(PFLOATOBJ,LONG);
typedef     VOID (APIENTRY *PFN_FLOATOBJ_Mul)(PFLOATOBJ,PFLOATOBJ);
typedef     VOID (APIENTRY *PFN_FLOATOBJ_DivFloat)(PFLOATOBJ,FLOATL);
typedef     VOID (APIENTRY *PFN_FLOATOBJ_DivLong)(PFLOATOBJ,LONG);
typedef     VOID (APIENTRY *PFN_FLOATOBJ_Div)(PFLOATOBJ,PFLOATOBJ);
typedef     VOID (APIENTRY *PFN_FLOATOBJ_Neg)(PFLOATOBJ);
typedef     BOOL (APIENTRY *PFN_FLOATOBJ_EqualLong)(PFLOATOBJ,LONG);
typedef     BOOL (APIENTRY *PFN_FLOATOBJ_GreaterThanLong)(PFLOATOBJ,LONG);
typedef     BOOL (APIENTRY *PFN_FLOATOBJ_LessThanLong)(PFLOATOBJ,LONG);
typedef     BOOL (APIENTRY *PFN_FLOATOBJ_Equal)(PFLOATOBJ,PFLOATOBJ);
typedef     BOOL (APIENTRY *PFN_FLOATOBJ_GreaterThan)(PFLOATOBJ,PFLOATOBJ);
typedef     BOOL (APIENTRY *PFN_FLOATOBJ_LessThan)(PFLOATOBJ,PFLOATOBJ);

#endif

typedef ULONG (APIENTRY *PFN_XFORMOBJ_iGetFloatObjXform)(
    XFORMOBJ *pxo,
    FLOATOBJ_XFORM * pfxo
    );

typedef VOID (APIENTRY *PFN_EngSort)(
    PBYTE pjBuf,
    ULONG c,
    ULONG cjElem,
    SORTCOMP pfnComp
...
typedef VOID (APIENTRY *PFN_EngQueryLocalTime)(
    PENG_TIME_FIELDS
    );

typedef FD_GLYPHSET* (APIENTRY *PFN_EngComputeGlyphSet)(
    INT nCodePage,
    INT nFirstChar,
    INT cChars
    );

typedef INT (APIENTRY *PFN_EngMultiByteToWideChar)(
    UINT CodePage,
...
typedef INT (APIENTRY *PFN_EngWideCharToMultiByte)(
    UINT CodePage,
    LPWSTR WideCharString,
    INT BytesInWideCharString,
    LPSTR MultiByteString,
...
typedef VOID (APIENTRY *PFN_EngGetCurrentCodePage)(
    PUSHORT OemCodePage,
    PUSHORT AnsiCodePage
    );

typedef HANDLE (APIENTRY *PFN_EngLoadModuleForWrite)(
    LPWSTR pwsz,
    ULONG  cjSizeOfModule
    );

typedef LARGE_INTEGER (APIENTRY *PFN_EngQueryFileTimeStamp )(
    LPWSTR  pwsz
    );

typedef BOOL (APIENTRY *PFN_EngGetFileChangeTime)(
    HANDLE          h,
    LARGE_INTEGER   *pChangeTime
    );

typedef BOOL (APIENTRY *PFN_EngGetFilePath)(
    IN  HANDLE h,
    OUT WCHAR *pDest
    );

typedef ULONG (APIENTRY *PFN_EngSaveFloatingPointState)(
    VOID   *pBuffer,
    ULONG   cjBufferSize
    );

typedef BOOL (APIENTRY *PFN_EngRestoreFloatingPointState)(
    VOID   *pBuffer
    );

typedef PDD_SURFACE_LOCAL (APIENTRY *PFN_EngLockDirectDrawSurface)(
        HANDLE hSurface
        );

typedef BOOL (APIENTRY *PFN_EngUnlockDirectDrawSurface)(
        PDD_SURFACE_LOCAL pSurface
        );

typedef BOOL (APIENTRY *PFN_EngDeleteEvent)(
    IN  PEVENT  pEvent
    );

typedef BOOL (APIENTRY *PFN_EngCreateEvent)(
    OUT PEVENT *ppEvent
    );

typedef BOOL (APIENTRY *PFN_EngUnmapEvent)(
    IN  PEVENT pEvent
    );

typedef PEVENT (APIENTRY *PFN_EngMapEvent)(
    IN  HDEV            hDev,
    IN  HANDLE          hUserObject,
    IN  PVOID           Reserved1,
    IN  PVOID           Reserved2,
...
typedef BOOL (APIENTRY *PFN_EngWaitForSingleObject)(
    IN  PEVENT          pEvent,
    IN  PLARGE_INTEGER  pTimeOut
    );

typedef LONG (APIENTRY *PFN_EngSetEvent)(
    IN PEVENT pEvent
    );

typedef VOID (APIENTRY *PFN_EngClearEvent )(
    IN PEVENT pEvent
    );

typedef LONG (APIENTRY *PFN_EngReadStateEvent )(
    IN PEVENT pEvent
    );

typedef BOOL (APIENTRY *PFN_EngQuerySystemAttribute)(
    ENG_SYSTEM_ATTRIBUTE CapNum,
    PDWORD pCapability);

typedef PVOID (APIENTRY *PFN_EngFntCacheLookUp)(ULONG FastCheckSum, ULONG * pulSize);

typedef PVOID (APIENTRY *PFN_EngFntCacheAlloc)(ULONG FastCheckSum, ULONG ulSize);

typedef VOID  (APIENTRY *PFN_EngFntCacheFault)(ULONG ulFastCheckSum, ULONG iFaultMode);

typedef BOOL (APIENTRY *PFN_EngQueryDeviceAttribute)(
    HDEV                    hdev,
    ENG_DEVICE_ATTRIBUTE    devAttr,
    VOID *                  pvIn,
    ULONG                   ulInSize,
...
typedef BOOL (APIENTRY *PFN_EngQueryEMFInfo)(
    HDEV              hdev,
    EMFINFO           *pEMFInfo);


typedef struct _ENGINE_INTERFACE_VERSION_1
{
    PFN_BRUSHOBJ_hGetColorTransform BRUSHOBJ_hGetColorTransform;
    PFN_BRUSHOBJ_pvAllocRbrush BRUSHOBJ_pvAllocRbrush;
    PFN_BRUSHOBJ_pvGetRbrush BRUSHOBJ_pvGetRbrush;
    PFN_BRUSHOBJ_ulGetBrushColor BRUSHOBJ_ulGetBrushColor;
    PFN_CLIPOBJ_bEnum CLIPOBJ_bEnum;
    PFN_CLIPOBJ_cEnumStart CLIPOBJ_cEnumStart;
    PFN_CLIPOBJ_ppoGetPath CLIPOBJ_ppoGetPath;
    PFN_EngAcquireSemaphore EngAcquireSemaphore;
    PFN_EngAllocMem EngAllocMem;
    PFN_EngAllocPrivateUserMem EngAllocPrivateUserMem;
    PFN_EngAllocUserMem EngAllocUserMem;
    PFN_EngAlphaBlend EngAlphaBlend;
    PFN_EngAssociateSurface EngAssociateSurface;
    PFN_EngBitBlt EngBitBlt;
    PFN_EngCheckAbort EngCheckAbort;
    PFN_EngClearEvent EngClearEvent;
    PFN_EngComputeGlyphSet EngComputeGlyphSet;
    PFN_EngControlSprites EngControlSprites;
    PFN_EngCopyBits EngCopyBits;
    PFN_EngCreateBitmap EngCreateBitmap;
    PFN_EngCreateClip EngCreateClip;
    PFN_EngCreateDeviceBitmap EngCreateDeviceBitmap;
    PFN_EngCreateDeviceSurface EngCreateDeviceSurface;
    PFN_EngCreateDriverObj EngCreateDriverObj;
    PFN_EngCreateEvent EngCreateEvent;
    PFN_EngCreatePalette EngCreatePalette;
    PFN_EngCreatePath EngCreatePath;
    PFN_EngCreateSemaphore EngCreateSemaphore;
    PFN_EngCreateWnd EngCreateWnd;
    PFN_EngDebugBreak EngDebugBreak;
    PFN_EngDebugPrint EngDebugPrint;
    PFN_EngDeleteClip EngDeleteClip;
    PFN_EngDeleteDriverObj EngDeleteDriverObj;
    PFN_EngDeleteEvent EngDeleteEvent;
    PFN_EngDeleteFile EngDeleteFile;
    PFN_EngDeletePalette EngDeletePalette;
    PFN_EngDeletePath EngDeletePath;
    PFN_EngDeleteSafeSemaphore EngDeleteSafeSemaphore;
    PFN_EngDeleteSemaphore EngDeleteSemaphore;
    PFN_EngDeleteSurface EngDeleteSurface;
    PFN_EngDeleteWnd EngDeleteWnd;
    PFN_EngDeviceIoControl EngDeviceIoControl;
    PFN_EngDitherColor EngDitherColor;
    PFN_EngDxIoctl EngDxIoctl;
    PFN_EngEnumForms EngEnumForms;
    PFN_EngEraseSurface EngEraseSurface;
    PFN_EngFillPath EngFillPath;
    PFN_EngFindImageProcAddress EngFindImageProcAddress;
    PFN_EngFindResource EngFindResource;
    PFN_EngFntCacheAlloc EngFntCacheAlloc;
    PFN_EngFntCacheFault EngFntCacheFault;
    PFN_EngFntCacheLookUp EngFntCacheLookUp;
    PFN_EngFreeMem EngFreeMem;
    PFN_EngFreeModule EngFreeModule;
    PFN_EngFreePrivateUserMem EngFreePrivateUserMem;
    PFN_EngFreeUserMem EngFreeUserMem;
    PFN_EngGetCurrentCodePage EngGetCurrentCodePage;
    PFN_EngGetCurrentProcessId EngGetCurrentProcessId;
    PFN_EngGetCurrentThreadId EngGetCurrentThreadId;
    PFN_EngGetDriverName EngGetDriverName;
    PFN_EngGetFileChangeTime EngGetFileChangeTime;
    PFN_EngGetFilePath EngGetFilePath;
    PFN_EngGetForm EngGetForm;
    PFN_EngGetLastError EngGetLastError;
    PFN_EngGetPrinter EngGetPrinter;
    PFN_EngGetPrinterData EngGetPrinterData;
    PFN_EngGetPrinterDataFileName EngGetPrinterDataFileName;
    PFN_EngGetPrinterDriver EngGetPrinterDriver;
    PFN_EngGetProcessHandle EngGetProcessHandle;
    PFN_EngGetType1FontList EngGetType1FontList;
    PFN_EngGradientFill EngGradientFill;
    PFN_EngHangNotification EngHangNotification;
    PFN_EngInitializeSafeSemaphore EngInitializeSafeSemaphore;
    PFN_EngIsSemaphoreOwned EngIsSemaphoreOwned;
    PFN_EngIsSemaphoreOwnedByCurrentThread EngIsSemaphoreOwnedByCurrentThread;
    PFN_EngLineTo EngLineTo;
    PFN_EngLoadImage EngLoadImage;
    PFN_EngLoadModule EngLoadModule;
    PFN_EngLoadModuleForWrite EngLoadModuleForWrite;
    PFN_EngLockDirectDrawSurface EngLockDirectDrawSurface;
    PFN_EngLockDriverObj EngLockDriverObj;
    PFN_EngLockSurface EngLockSurface;
    PFN_EngLpkInstalled EngLpkInstalled;
    PFN_EngMapEvent EngMapEvent;
    PFN_EngMapFile EngMapFile;
    PFN_EngMapFontFile EngMapFontFile;
    PFN_EngMapFontFileFD EngMapFontFileFD;
    PFN_EngMapModule EngMapModule;
    PFN_EngMarkBandingSurface EngMarkBandingSurface;
    PFN_EngModifySurface EngModifySurface;
    PFN_EngMovePointer EngMovePointer;
    PFN_EngMulDiv EngMulDiv;
    PFN_EngMultiByteToUnicodeN EngMultiByteToUnicodeN;
    PFN_EngMultiByteToWideChar EngMultiByteToWideChar;
    PFN_EngPaint EngPaint;
    PFN_EngPlgBlt EngPlgBlt;
    PFN_EngProbeForRead EngProbeForRead;
    PFN_EngProbeForReadAndWrite EngProbeForReadAndWrite;
    PFN_EngQueryDeviceAttribute EngQueryDeviceAttribute;
    PFN_EngQueryLocalTime EngQueryLocalTime;
    PFN_EngQueryPalette EngQueryPalette;
    PFN_EngQueryPerformanceCounter EngQueryPerformanceCounter;
    PFN_EngQueryPerformanceFrequency EngQueryPerformanceFrequency;
    PFN_EngQuerySystemAttribute EngQuerySystemAttribute;
    PFN_EngReadStateEvent EngReadStateEvent;
    PFN_EngReleaseSemaphore EngReleaseSemaphore;
    PFN_EngRestoreFloatingPointState EngRestoreFloatingPointState;
    PFN_EngSaveFloatingPointState EngSaveFloatingPointState;
    PFN_EngSecureMem EngSecureMem;
    PFN_EngSetEvent EngSetEvent;
    PFN_EngSetLastError EngSetLastError;
    PFN_EngSetPointerShape EngSetPointerShape;
    PFN_EngSetPointerTag EngSetPointerTag;
    PFN_EngSetPrinterData EngSetPrinterData;
    PFN_EngSort EngSort;
    PFN_EngStretchBlt EngStretchBlt;
    PFN_EngStretchBltROP EngStretchBltROP;
    PFN_EngStrokeAndFillPath EngStrokeAndFillPath;
    PFN_EngStrokePath EngStrokePath;
    PFN_EngTextOut EngTextOut;
    PFN_EngTransparentBlt EngTransparentBlt;
    PFN_EngUnicodeToMultiByteN EngUnicodeToMultiByteN;
    PFN_EngUnloadImage EngUnloadImage;
    PFN_EngUnlockDirectDrawSurface EngUnlockDirectDrawSurface;
    PFN_EngUnlockDriverObj EngUnlockDriverObj;
    PFN_EngUnlockSurface EngUnlockSurface;
    PFN_EngUnmapEvent EngUnmapEvent;
    PFN_EngUnmapFile EngUnmapFile;
    PFN_EngUnmapFontFile EngUnmapFontFile;
    PFN_EngUnmapFontFileFD EngUnmapFontFileFD;
    PFN_EngUnsecureMem EngUnsecureMem;
    PFN_EngWaitForSingleObject EngWaitForSingleObject;
    PFN_EngWideCharToMultiByte EngWideCharToMultiByte;
    PFN_EngWritePrinter EngWritePrinter;

#if defined(_X86_)
    PFN_FLOATOBJ_Add FLOATOBJ_Add;
    PFN_FLOATOBJ_AddFloat FLOATOBJ_AddFloat;
    PFN_FLOATOBJ_AddLong FLOATOBJ_AddLong;
    PFN_FLOATOBJ_Div FLOATOBJ_Div;
    PFN_FLOATOBJ_DivFloat FLOATOBJ_DivFloat;
    PFN_FLOATOBJ_DivLong FLOATOBJ_DivLong;
    PFN_FLOATOBJ_Equal FLOATOBJ_Equal;
    PFN_FLOATOBJ_EqualLong FLOATOBJ_EqualLong;
    PFN_FLOATOBJ_GetFloat FLOATOBJ_GetFloat;
    PFN_FLOATOBJ_GetLong FLOATOBJ_GetLong;
    PFN_FLOATOBJ_GreaterThan FLOATOBJ_GreaterThan;
    PFN_FLOATOBJ_GreaterThanLong FLOATOBJ_GreaterThanLong;
    PFN_FLOATOBJ_LessThan FLOATOBJ_LessThan;
    PFN_FLOATOBJ_LessThanLong FLOATOBJ_LessThanLong;
    PFN_FLOATOBJ_Mul FLOATOBJ_Mul;
    PFN_FLOATOBJ_MulFloat FLOATOBJ_MulFloat;
    PFN_FLOATOBJ_MulLong FLOATOBJ_MulLong;
    PFN_FLOATOBJ_Neg FLOATOBJ_Neg;
    PFN_FLOATOBJ_SetFloat FLOATOBJ_SetFloat;
    PFN_FLOATOBJ_SetLong FLOATOBJ_SetLong;
    PFN_FLOATOBJ_Sub FLOATOBJ_Sub;
    PFN_FLOATOBJ_SubFloat FLOATOBJ_SubFloat;
    PFN_FLOATOBJ_SubLong FLOATOBJ_SubLong;
#endif

    PFN_FONTOBJ_cGetAllGlyphHandles FONTOBJ_cGetAllGlyphHandles;
    PFN_FONTOBJ_cGetGlyphs FONTOBJ_cGetGlyphs;
    PFN_FONTOBJ_pfdg FONTOBJ_pfdg;
    PFN_FONTOBJ_pifi FONTOBJ_pifi;
    PFN_FONTOBJ_pjOpenTypeTablePointer FONTOBJ_pjOpenTypeTablePointer;
    PFN_FONTOBJ_pQueryGlyphAttrs FONTOBJ_pQueryGlyphAttrs;
    PFN_FONTOBJ_pvTrueTypeFontFile FONTOBJ_pvTrueTypeFontFile;
    PFN_FONTOBJ_pwszFontFilePaths FONTOBJ_pwszFontFilePaths;
    PFN_FONTOBJ_pxoGetXform FONTOBJ_pxoGetXform;
    PFN_FONTOBJ_vGetInfo FONTOBJ_vGetInfo;
    PFN_HT_ComputeRGBGammaTable HT_ComputeRGBGammaTable;
    PFN_HT_Get8BPPFormatPalette HT_Get8BPPFormatPalette;
    PFN_HT_Get8BPPMaskPalette HT_Get8BPPMaskPalette;
    PFN_HeapVidMemAllocAligned HeapVidMemAllocAligned;
    PFN_PALOBJ_cGetColors PALOBJ_cGetColors;
    PFN_PATHOBJ_bCloseFigure PATHOBJ_bCloseFigure;
    PFN_PATHOBJ_bEnum PATHOBJ_bEnum;
    PFN_PATHOBJ_bEnumClipLines PATHOBJ_bEnumClipLines;
    PFN_PATHOBJ_bMoveTo PATHOBJ_bMoveTo;
    PFN_PATHOBJ_bPolyBezierTo PATHOBJ_bPolyBezierTo;
    PFN_PATHOBJ_bPolyLineTo PATHOBJ_bPolyLineTo;
    PFN_PATHOBJ_vEnumStart PATHOBJ_vEnumStart;
    PFN_PATHOBJ_vEnumStartClipLines PATHOBJ_vEnumStartClipLines;
    PFN_PATHOBJ_vGetBounds PATHOBJ_vGetBounds;
    PFN_STROBJ_bEnum STROBJ_bEnum;
    PFN_STROBJ_bEnumPositionsOnly STROBJ_bEnumPositionsOnly;
    PFN_STROBJ_bGetAdvanceWidths STROBJ_bGetAdvanceWidths;
    PFN_STROBJ_dwGetCodePage STROBJ_dwGetCodePage;
    PFN_STROBJ_fxBreakExtra STROBJ_fxBreakExtra;
    PFN_STROBJ_fxCharacterExtra STROBJ_fxCharacterExtra;
    PFN_STROBJ_vEnumStart STROBJ_vEnumStart;
    PFN_VidMemFree VidMemFree;
    PFN_WNDOBJ_bEnum WNDOBJ_bEnum;
    PFN_WNDOBJ_cEnumStart WNDOBJ_cEnumStart;
    PFN_WNDOBJ_vSetConsumer WNDOBJ_vSetConsumer;
    PFN_XFORMOBJ_bApplyXform XFORMOBJ_bApplyXform;
    PFN_XFORMOBJ_iGetFloatObjXform XFORMOBJ_iGetFloatObjXform;
    PFN_XFORMOBJ_iGetXform XFORMOBJ_iGetXform;
    PFN_XLATEOBJ_cGetPalette XLATEOBJ_cGetPalette;
    PFN_XLATEOBJ_hGetColorTransform XLATEOBJ_hGetColorTransform;
    PFN_XLATEOBJ_iXlate XLATEOBJ_iXlate;
    PFN_XLATEOBJ_piVector XLATEOBJ_piVector;

} ENGINE_INTERFACE_VERSION_1, *PENGINE_INTERFACE_VERSION_1;
