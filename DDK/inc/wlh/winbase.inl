...
HMODULE WINAPI IsolationAwareGetModuleHandleA(LPCSTR lpModuleName);
HMODULE WINAPI IsolationAwareGetModuleHandleW(LPCWSTR lpModuleName);
...
#define IsolationAwareGetModuleHandle IsolationAwareGetModuleHandleW
...
#define IsolationAwareGetModuleHandle IsolationAwareGetModuleHandleA
...
ISOLATION_AWARE_INLINE HMODULE WINAPI IsolationAwareGetModuleHandleA(LPCSTR lpModuleName)
{
    HMODULE moduleResult = NULL;
    ULONG_PTR  ulpCookie = 0;
    const BOOL fActivateActCtxSuccess = IsolationAwarePrivateT_SqbjaYRiRY || IsolationAwarePrivatenPgViNgRzlnPgpgk(&ulpCookie);
    ...
    __try
    {
        moduleResult = GetModuleHandleA(lpModuleName);
    }
    __finally
    {
        if (!IsolationAwarePrivateT_SqbjaYRiRY)
...
ISOLATION_AWARE_INLINE HMODULE WINAPI IsolationAwareGetModuleHandleW(LPCWSTR lpModuleName)
{
    HMODULE moduleResult = NULL;
    ULONG_PTR  ulpCookie = 0;
    const BOOL fActivateActCtxSuccess = IsolationAwarePrivateT_SqbjaYRiRY || IsolationAwarePrivatenPgViNgRzlnPgpgk(&ulpCookie);
    ...
    __try
    {
        moduleResult = GetModuleHandleW(lpModuleName);
    }
    __finally
    {
        if (!IsolationAwarePrivateT_SqbjaYRiRY)
...
#define FindActCtxSectionStringW IsolationAwareFindActCtxSectionStringW
 /* GetModuleHandleA skipped for compatibility with XP SDK */
 /* GetModuleHandleW skipped for compatibility with XP SDK */
