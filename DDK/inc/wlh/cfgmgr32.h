...
#ifndef DWORD_MAX
#define DWORD_MAX             ((ULONG) -1)
#endif
#ifndef DWORDLONG_MAX
#define DWORDLONG_MAX         ((ULONGLONG) -1)
#endif
...
//
// Flags for CM_Apply_PowerScheme
//
#define CM_APPLY_ACTIVE_POWER_SCHEME    (0x00000000)
#define CM_APPLY_VACANT_POWER_SCHEME    (0x00000001)
...
//
// Device interface state flags (retrievable via
// CM_Get_Interface_Device_Detail)
//
#define CM_DEVICE_INTERFACE_STATE_PRESENT  (0x00000001)
...
CONFIGRET
WINAPI
CM_Get_Device_Interface_DetailA(
    OUT PDEVINST pdnDevInst,
    IN  LPCSTR   pszDeviceInterface,
    OUT LPGUID   InterfaceClassGuid  OPTIONAL,
    OUT PULONG   pulState            OPTIONAL,
    IN  ULONG    ulFlags
    );
CMAPI
CONFIGRET
WINAPI
CM_Get_Device_Interface_DetailW(
    OUT PDEVINST pdnDevInst,
...
CONFIGRET
WINAPI
CM_Get_Device_Interface_Detail_ExA(
    OUT PDEVINST pdnDevInst,
    IN  LPCSTR   pszDeviceInterface,
    OUT LPGUID   InterfaceClassGuid  OPTIONAL,
    OUT PULONG   pulState            OPTIONAL,
...
CONFIGRET
WINAPI
CM_Get_Device_Interface_Detail_ExW(
    OUT PDEVINST pdnDevInst,
    IN  LPCWSTR  pszDeviceInterface,
    OUT LPGUID   InterfaceClassGuid  OPTIONAL,
    OUT PULONG   pulState            OPTIONAL,
...
#ifdef UNICODE
#define CM_Get_Device_Interface_Detail     CM_Get_Device_Interface_DetailW
#define CM_Get_Device_Interface_Detail_Ex  CM_Get_Device_Interface_Detail_ExW
#else
#define CM_Get_Device_Interface_Detail     CM_Get_Device_Interface_DetailA
#define CM_Get_Device_Interface_Detail_Ex  CM_Get_Device_Interface_Detail_ExA
#endif // UNICODE
...
CONFIGRET
WINAPI
CM_Get_Device_Interface_DefaultA(
    IN     LPGUID   InterfaceGuid,
    OUT    LPSTR    pszDefaultDeviceInterface,
    IN OUT PULONG   pulLength,
    IN     ULONG    ulFlags
    );
CMAPI
CONFIGRET
WINAPI
CM_Get_Device_Interface_DefaultW(
    IN     LPGUID   InterfaceGuid,
    OUT    LPWSTR   pszDefaultDeviceInterface,
    IN OUT PULONG   pulLength,
    IN     ULONG    ulFlags
    );
CMAPI
CONFIGRET
WINAPI
CM_Get_Device_Interface_Default_ExA(
    IN     LPGUID   InterfaceGuid,
    OUT    LPSTR    pszDefaultDeviceInterface,
    IN OUT PULONG   pulLength,
    IN     ULONG    ulFlags,
...
CONFIGRET
WINAPI
CM_Get_Device_Interface_Default_ExW(
    IN     LPGUID   InterfaceGuid,
    OUT    LPWSTR   pszDefaultDeviceInterface,
    IN OUT PULONG   pulLength,
    IN     ULONG    ulFlags,
...
#ifdef UNICODE
#define CM_Get_Device_Interface_Default     CM_Get_Device_Interface_DefaultW
#define CM_Get_Device_Interface_Default_Ex  CM_Get_Device_Interface_Default_ExW
#else
#define CM_Get_Device_Interface_Default     CM_Get_Device_Interface_DefaultA
#define CM_Get_Device_Interface_Default_Ex  CM_Get_Device_Interface_Default_ExA
#endif // UNICODE
...
CONFIGRET
WINAPI
CM_Set_Device_Interface_DefaultA(
    IN     LPGUID   InterfaceGuid,
    IN     LPSTR    pszDefaultDeviceInterface  OPTIONAL,
    IN     ULONG    ulFlags
    );
CMAPI
CONFIGRET
WINAPI
CM_Set_Device_Interface_DefaultW(
    IN     LPGUID   InterfaceGuid,
    IN     LPWSTR   pszDefaultDeviceInterface  OPTIONAL,
    IN     ULONG    ulFlags
    );
CMAPI
CONFIGRET
WINAPI
CM_Set_Device_Interface_Default_ExA(
    IN     LPGUID   InterfaceGuid,
    IN     LPSTR    pszDefaultDeviceInterface  OPTIONAL,
    IN     ULONG    ulFlags,
    IN     HMACHINE hMachine
...
CONFIGRET
WINAPI
CM_Set_Device_Interface_Default_ExW(
    IN     LPGUID   InterfaceGuid,
    IN     LPWSTR   pszDefaultDeviceInterface  OPTIONAL,
    IN     ULONG    ulFlags,
    IN     HMACHINE hMachine
...
#ifdef UNICODE
#define CM_Set_Device_Interface_Default     CM_Set_Device_Interface_DefaultW
#define CM_Set_Device_Interface_Default_Ex  CM_Set_Device_Interface_Default_ExW
#else
#define CM_Set_Device_Interface_Default     CM_Set_Device_Interface_DefaultA
#define CM_Set_Device_Interface_Default_Ex  CM_Set_Device_Interface_Default_ExA
#endif // UNICODE
...
CM_Open_Class_Key_ExA(
             IN OPTIONAL LPGUID   pszClassGuid,
             IN OPTIONAL LPCSTR   pszClassName,
             IN REGSAM            samDesired,
             IN REGDISPOSITION    Disposition,
             OUT PHKEY            phkClass,
...
CM_Register_Device_InterfaceA(
             IN DEVINST          dnDevInst,
             IN LPGUID           InterfaceClassGuid,
             IN OPTIONAL LPCSTR  pszReference,
...
CM_Register_Device_InterfaceW(
             IN DEVINST           dnDevInst,
             IN LPGUID            InterfaceClassGuid,
             IN OPTIONAL LPCWSTR  pszReference,
...
#ifdef UNICODE
#define CM_Get_Link_Node_ID    CM_Get_Link_Node_IDW
#define CM_Get_Link_Node_ID_Ex CM_Get_Link_Node_ID_ExW
#else
#define CM_Get_Link_Node_ID    CM_Get_Link_Node_IDA
#define CM_Get_Link_Node_ID_Ex CM_Get_Link_Node_ID_ExA
#endif
...
CONFIGRET
WINAPI
CM_Device_Affinity_Policy(
    IN DEVINST  dnDevInst,
    IN BOOLEAN  SetPolicy,
    IN OUT PULONG     Policy,
    IN OUT PULONG     Priority,
    IN OUT PULONGLONG Affinity,
    IN ULONG    ulFlags
    );
CMAPI
CONFIGRET
WINAPI
CM_Device_Affinity_Policy_Ex(
    IN DEVINST  dnDevInst,
    IN BOOLEAN  SetPolicy,
    IN OUT PULONG     Policy,
    IN OUT PULONG     Priority,
