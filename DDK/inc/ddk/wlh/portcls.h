 ...
 * IRTPort
 *****************************************************************************
 * Interface for RT port lower edge.
 */
DECLARE_INTERFACE_(IRTPort,IPort)
{
    DEFINE_ABSTRACT_UNKNOWN()   //  For IUnknown
 ...
 * IRTPortStream
 *****************************************************************************
 * Interface for RT stream port lower edge.
 */
DECLARE_INTERFACE_(IRTPortStream,IUnknown)
{
    DEFINE_ABSTRACT_UNKNOWN()   //  For IUnknown
...
typedef IRTPortStream *PRTPORTSTREAM;

#ifdef PC_IMPLEMENTATION
#define IMP_IRTPortStream\
 ...
 * IRTMiniportStream
 *****************************************************************************
 * Interface for RT miniport stream.
 */
DECLARE_INTERFACE_(IRTMiniportStream,IUnknown)
{
    DEFINE_ABSTRACT_UNKNOWN()   //  For IUnknown
...
typedef IRTMiniportStream *PRTMINIPORTSTREAM;

#define IMP_IRTMiniportStream\
    STDMETHODIMP_(NTSTATUS) SetFormat\
    (   IN      PKSDATAFORMAT   DataFormat\
    );\
    STDMETHODIMP_(NTSTATUS) SetState\
 ...
 * IRTMiniport
 *****************************************************************************
 * Interface for RT miniports.
 */
DECLARE_INTERFACE_(IRTMiniport,IMiniport)
{
    DEFINE_ABSTRACT_UNKNOWN()   //  For IUnknown
...
typedef IRTMiniport *PRTMINIPORT;

#define IMP_IRTMiniport\
    IMP_IMiniport;\
    STDMETHODIMP_(NTSTATUS) Init\
    (   IN      PUNKNOWN            UnknownAdapter,\
        IN      PRESOURCELIST       ResourceList,\
