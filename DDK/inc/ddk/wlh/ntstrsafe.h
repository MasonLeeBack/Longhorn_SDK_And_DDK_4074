...
NTSTRSAFEDDI RtlStringCchCopyA(__out_ecount(cchDest) char* pszDest, __in size_t cchDest, const char* pszSrc);
NTSTRSAFEDDI RtlStringCchCopyW(__out_ecount(cchDest) wchar_t* pszDest, __in size_t cchDest, const wchar_t* pszSrc);
...
NTSTRSAFEDDI RtlStringCbCopyA(__out_bcount(cbDest) char* pszDest, __in size_t cbDest, const char* pszSrc);
NTSTRSAFEDDI RtlStringCbCopyW(__out_bcount(cbDest) wchar_t* pszDest, __in size_t cbDest, const wchar_t* pszSrc);
...
NTSTRSAFEDDI RtlStringCchCopyExA(__out_ecount(cchDest) __opt char* pszDest, __in size_t cchDest, const char* pszSrc, __out __opt char** ppszDestEnd, __out __opt size_t* pcchRemaining, unsigned long dwFlags);
NTSTRSAFEDDI RtlStringCchCopyExW(__out_ecount(cchDest) __opt wchar_t* pszDest, __in size_t cchDest, const wchar_t* pszSrc, __out __opt wchar_t** ppszDestEnd, __out __opt size_t* pcchRemaining, unsigned long dwFlags);
...
NTSTRSAFEDDI RtlStringCbCopyExA(__out_bcount(cbDest) __opt char* pszDest, __in size_t cbDest, const char* pszSrc, __out __opt char** ppszDestEnd, __out __opt size_t* pcbRemaining, unsigned long dwFlags);
NTSTRSAFEDDI RtlStringCbCopyExW(__out_bcount(cbDest) __opt wchar_t* pszDest, __in size_t cbDest, const wchar_t* pszSrc, __out __opt wchar_t** ppszDestEnd, __out __opt size_t* pcbRemaining, unsigned long dwFlags);
...
NTSTRSAFEDDI RtlStringCchCopyNA(__out_ecount(cchDest) char* pszDest, __in size_t cchDest, __in_ecount(cchSrc)  const char* pszSrc, __in size_t cchSrc);
NTSTRSAFEDDI RtlStringCchCopyNW(__out_ecount(cchDest) wchar_t* pszDest, __in size_t cchDest, __in_ecount(cchSrc)  const wchar_t* pszSrc, __in size_t cchSrc);
...
NTSTRSAFEDDI RtlStringCbCopyNA(__out_bcount(cbDest) char* pszDest, __in size_t cbDest, __in_bcount(cbSrc)  const char* pszSrc, __in size_t cbSrc);
NTSTRSAFEDDI RtlStringCbCopyNW(__out_bcount(cbDest) wchar_t* pszDest, __in size_t cbDest, __in_bcount(cbSrc)  const wchar_t* pszSrc, __in size_t cbSrc);
...
NTSTRSAFEDDI RtlStringCchCopyNExA(__out_ecount(cchDest) __opt char* pszDest, __in size_t cchDest, __in_ecount(cchSrc) __opt  const char* pszSrc, __in size_t cchSrc, __out __opt char** ppszDestEnd,
                             __out __opt size_t* pcchRemaining, unsigned long dwFlags);
NTSTRSAFEDDI RtlStringCchCopyNExW(__out_ecount(cchDest) __opt wchar_t* pszDest, __in size_t cchDest, __in_ecount(cchSrc) __opt  const wchar_t* pszSrc, __in size_t cchSrc, __out __opt wchar_t** ppszDestEnd,
                             __out __opt size_t* pcchRemaining, unsigned long dwFlags);
...
NTSTRSAFEDDI RtlStringCbCopyNExA(__out_bcount(cbDest) __opt char* pszDest, __in size_t cbDest, __in_bcount(cbSrc) __opt const char* pszSrc, __in size_t cbSrc, __out __opt char** ppszDestEnd,
                            __out __opt size_t* pcbRemaining, unsigned long dwFlags);
NTSTRSAFEDDI RtlStringCbCopyNExW(__out_bcount(cbDest) __opt wchar_t* pszDest, __in size_t cbDest, __in_bcount(cbSrc) __opt const wchar_t* pszSrc, __in size_t cbSrc, __out __opt wchar_t** ppszDestEnd,
                            __out __opt size_t* pcbRemaining, unsigned long dwFlags);
...
NTSTRSAFEDDI RtlStringCchCatA(__inout_ecount(cchDest) char* pszDest, __in size_t cchDest, const char* pszSrc);
NTSTRSAFEDDI RtlStringCchCatW(__inout_ecount(cchDest) wchar_t* pszDest, __in size_t cchDest, const wchar_t* pszSrc);
...
NTSTRSAFEDDI RtlStringCbCatA(__inout_bcount(cbDest) char* pszDest, __in size_t cbDest, const char* pszSrc);
NTSTRSAFEDDI RtlStringCbCatW(__inout_bcount(cbDest) wchar_t* pszDest, __in size_t cbDest, const wchar_t* pszSrc);
...
NTSTRSAFEDDI RtlStringCchCatExA(__inout_ecount(cchDest) __opt char* pszDest, __in size_t cchDest, const char* pszSrc, __out __opt char** ppszDestEnd, __out __opt size_t* pcchRemaining, unsigned long dwFlags);
NTSTRSAFEDDI RtlStringCchCatExW(__inout_ecount(cchDest) __opt wchar_t* pszDest, __in size_t cchDest, const wchar_t* pszSrc, __out __opt wchar_t** ppszDestEnd, __out __opt size_t* pcchRemaining, unsigned long dwFlags);
...
NTSTRSAFEDDI RtlStringCbCatExA(__inout_bcount(cbDest) __opt char* pszDest, __in size_t cbDest, const char* pszSrc, __out __opt  char** ppszDestEnd, __out __opt  size_t* pcbRemaining, unsigned long dwFlags);
NTSTRSAFEDDI RtlStringCbCatExW(__inout_bcount(cbDest) __opt wchar_t* pszDest, __in size_t cbDest, const wchar_t* pszSrc, __out __opt  wchar_t** ppszDestEnd, __out __opt  size_t* pcbRemaining, unsigned long dwFlags);
...
NTSTRSAFEDDI RtlStringCchCatNA(__inout_ecount(cchDest) char* pszDest, __in size_t cchDest, const char* pszSrc, size_t cchMaxAppend);
NTSTRSAFEDDI RtlStringCchCatNW(__inout_ecount(cchDest) wchar_t* pszDest, __in size_t cchDest, const wchar_t* pszSrc, size_t cchMaxAppend);
...
NTSTRSAFEDDI RtlStringCbCatNA(__inout_bcount(cbDest) char* pszDest, __in size_t cbDest, const char* pszSrc, size_t cbMaxAppend);
NTSTRSAFEDDI RtlStringCbCatNW(__inout_bcount(cbDest) wchar_t* pszDest, __in size_t cbDest, const wchar_t* pszSrc, size_t cbMaxAppend);
...
NTSTRSAFEDDI RtlStringCchCatNExA(__inout_ecount(cchDest) __opt char* pszDest, __in size_t cchDest, const char* pszSrc, size_t cchMaxAppend, __out __opt char** ppszDestEnd, __out __opt size_t* pcchRemaining, unsigned long dwFlags);
NTSTRSAFEDDI RtlStringCchCatNExW(__inout_ecount(cchDest) __opt wchar_t* pszDest, __in size_t cchDest, const wchar_t* pszSrc, size_t cchMaxAppend, __out __opt wchar_t** ppszDestEnd, __out __opt size_t* pcchRemaining, unsigned long dwFlags);
...
NTSTRSAFEDDI RtlStringCbCatNExA(__inout_bcount(cbDest) __opt char* pszDest, __in size_t cbDest, const char* pszSrc, size_t cbMaxAppend, __out __opt char** ppszDestEnd, __out __opt size_t* pcbRemaining, unsigned long dwFlags);
NTSTRSAFEDDI RtlStringCbCatNExW(__inout_bcount(cbDest) __opt wchar_t* pszDest, __in size_t cbDest, const wchar_t* pszSrc, size_t cbMaxAppend, __out __opt wchar_t** ppszDestEnd, __out __opt size_t* pcbRemaining, unsigned long dwFlags);
...
NTSTRSAFEDDI RtlStringCchVPrintfA(__out_ecount(cchDest) char* pszDest, __in size_t cchDest, const char* pszFormat, va_list argList);
NTSTRSAFEDDI RtlStringCchVPrintfW(__out_ecount(cchDest) wchar_t* pszDest, __in size_t cchDest, const wchar_t* pszFormat, va_list argList);
...
NTSTRSAFEDDI RtlStringCbVPrintfA(__out_bcount(cbDest) char* pszDest, __in size_t cbDest, const char* pszFormat, va_list argList);
NTSTRSAFEDDI RtlStringCbVPrintfW(__out_bcount(cbDest) wchar_t* pszDest, __in size_t cbDest, const wchar_t* pszFormat, va_list argList);
...
NTSTRSAFEDDI RtlStringCchPrintfA(__out_ecount(cchDest) char* pszDest, __in size_t cchDest, const char* pszFormat, ...);
NTSTRSAFEDDI RtlStringCchPrintfW(__out_ecount(cchDest) wchar_t* pszDest, __in size_t cchDest, const wchar_t* pszFormat, ...);
...
NTSTRSAFEDDI RtlStringCbPrintfA(__out_bcount(cbDest) char* pszDest, __in size_t cbDest, const char* pszFormat, ...);
NTSTRSAFEDDI RtlStringCbPrintfW(__out_bcount(cbDest) wchar_t* pszDest, __in size_t cbDest, const wchar_t* pszFormat, ...);
...
NTSTRSAFEDDI RtlStringCchPrintfExA(__out_ecount(cchDest) __opt char* pszDest, __in size_t cchDest, __out __opt char** ppszDestEnd, __out __opt size_t* pcchRemaining, unsigned long dwFlags, const char* pszFormat, ...);
NTSTRSAFEDDI RtlStringCchPrintfExW(__out_ecount(cchDest) __opt wchar_t* pszDest, __in size_t cchDest, __out __opt wchar_t** ppszDestEnd, __out __opt size_t* pcchRemaining, unsigned long dwFlags, const wchar_t* pszFormat, ...);
...
NTSTRSAFEDDI RtlStringCbPrintfExA(__out_bcount(cbDest) __opt char* pszDest, __in size_t cbDest, __out __opt char** ppszDestEnd, __out __opt size_t* pcbRemaining, unsigned long dwFlags, const char* pszFormat, ...);
NTSTRSAFEDDI RtlStringCbPrintfExW(__out_bcount(cbDest) __opt wchar_t* pszDest, __in size_t cbDest, __out __opt wchar_t** ppszDestEnd, __out __opt size_t* pcbRemaining, unsigned long dwFlags, const wchar_t* pszFormat, ...);
...
NTSTRSAFEDDI RtlStringCchVPrintfExA(__out_ecount(cchDest) __opt char* pszDest, __in size_t cchDest, __out __opt char** ppszDestEnd, __out __opt  size_t* pcchRemaining, unsigned long dwFlags, const char* pszFormat, va_list argList);
NTSTRSAFEDDI RtlStringCchVPrintfExW(__out_ecount(cchDest) __opt wchar_t* pszDest, __in size_t cchDest, __out __opt wchar_t** ppszDestEnd, __out __opt size_t* pcchRemaining, unsigned long dwFlags, const wchar_t* pszFormat, va_list argList);
...
NTSTRSAFEDDI RtlStringCbVPrintfExA(__out_bcount(cbDest) __opt char* pszDest, __in size_t cbDest, __out __opt char** ppszDestEnd, __out __opt size_t* pcbRemaining, unsigned long dwFlags, const char* pszFormat, va_list argList);
NTSTRSAFEDDI RtlStringCbVPrintfExW(__out_bcount(cbDest) __opt wchar_t* pszDest, __in size_t cbDest, __out __opt wchar_t** ppszDestEnd, __out __opt size_t* pcbRemaining, unsigned long dwFlags, const wchar_t* pszFormat, va_list argList);
...
NTSTRSAFEDDI RtlStringCchLengthA(__in_ecount(cchMax) const char* psz, __in size_t cchMax, __out __opt size_t* pcch);
NTSTRSAFEDDI RtlStringCchLengthW(__in_ecount(cchMax) const wchar_t* psz, __in size_t cchMax, __out __opt size_t* pcch);
...
NTSTRSAFEDDI RtlStringCbLengthA(__in_bcount(cbMax) const char* psz, __in size_t cbMax, __out __opt size_t* pcch);
NTSTRSAFEDDI RtlStringCbLengthW(__in_bcount(cbMax) const wchar_t* psz, __in size_t cbMax, __out __opt size_t* pcch);
